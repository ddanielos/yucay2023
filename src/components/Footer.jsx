...
function Footer() {
  return (
    <div className="text-primary-color w-auto">
      <div className="flex flex-col-reverse md:flex-row md:h-80 xl:h-96 w-auto">
        <div className="bg-[#f08165] md:w-1/2 p-6 xl:p-10 text-center md:text-left">
          <h2 className="uppercase font-bioRhyme tracking-[0.1rem] text-4xl md:text-5xl xl:text-7xl my-4">Contacto</h2>
        ...
        <div className="bg-[#d44620] md:w-1/2 p-6 xl:p-10 text-center md:text-left">
          <h2 className="uppercase font-bioRhyme tracking-[0.1rem] text-4xl md:text-5xl xl:text-7xl my-4">Suscripcion</h2>
