  ...
  return(
    <div className="py-[20px] md:py-[60px] md:px-0">
      <Link className="visited:text-inherit visited:no-underline visited:outline-none" href={`/blogs/${Slug}`}>
        <div className=" rounded-2xl overflow-hidden shadow-[6px_6px_3px_rgba(198,106,72,0.3)] hover:-translate-y-[2%] flex flex-col w-[330px] md:w-[400px] h-[450px] mr-2.5 cursor-pointer transition-all">
