...
// Esta función obtiene los paths estáticos para cada artículo
...
// Esta función genera los metadatos para cada página
...
// Esta es la página del artículo
export default async function BlogPost({ params }) {
  ...
  // Define cómo quieres renderizar los nodos embebidos (assets)
  const options = {
    renderNode: {
